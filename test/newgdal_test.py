...
FORMATS = {GDALGrid:['EHdr'],
           GMTGrid:['netcdf','hdf','native']}
        ...
        for fileformat in FORMATS[gridclass]:
            ...
            try:
                ...
                sampledict = GeoDict({'xmin':1,
                                      ...
                                      'nx':3,
                                      'ny':3})
                testdata = np.array([[7,8,9],[12,13,14],[17,18,19]],dtype=np.float32)
                testdict = GeoDict({'xmin':1,
                                    'xmax':3,
                                    'ymin':1,
                                    'ymax':3,
                                    'dx':1,
        ...
        for fileformat in FORMATS[gridclass]:
            ...
            try:
                ...
                sampledict = GeoDict({'xmin':-1,
                                      ...
                                      'nx':3,
                                      'ny':3})
                testdata = np.array([[np.nan,6,7],[np.nan,11,12],[np.nan,16,17]],dtype=np.float32)
                testdict = GeoDict({'xmin':-1,
                                    'xmax':1,
                                    'ymin':1,
                                    'ymax':3,
        ...
        for fileformat in FORMATS[gridclass]:
            ...
            try:
                ...
                sampledict = GeoDict({'xmin':60,
                                      ...
                                      'nx':4,
                                      'ny':2})
                testdata = np.array([[11,12,7,8],
                                     [17,18,13,14],
                                     ],dtype=np.float32)
                testdict = GeoDict({'xmin':60,
                                    'xmax':-120,
                                    'ymin':0,
                                    'ymax':45,
                                    'dx':60,
        ...
        for fileformat in FORMATS[gridclass]:
            ...
            try:
                ...
                sampledict = GeoDict({'xmin':90,
                                      ...
                                      'nx':3,
                                      'ny':2})
                testdata = np.array([[14.5,12.5,10.5],
                                     [20.5,18.5,16.5],
                                     ],dtype=np.float32)
                testdict = GeoDict({'xmin':90,
                                    'xmax':-150,
